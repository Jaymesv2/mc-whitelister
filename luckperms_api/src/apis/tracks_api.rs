...
pub async fn create_track(
    ...
    new_track: Option<models::NewTrack>,
) -> Result<models::Track, Error<CreateTrackError>> {
...
pub async fn delete_track(
    ...
    let uri_str = format!(
        ...
        trackName = crate::apis::urlencode(p_path_track_name)
    );
    let mut req_builder = configuration
        .client
...
pub async fn get_track(
    configuration: &configuration::Configuration,
    track_name: &str,
) -> Result<models::Track, Error<GetTrackError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_track_name = track_name;
...
pub async fn get_tracks(
    configuration: &configuration::Configuration,
) -> Result<Vec<String>, Error<GetTracksError>> {
    let uri_str = format!("{}/track", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn patch_track(
    configuration: &configuration::Configuration,
    track_name: &str,
    patch_track_request: Option<models::PatchTrackRequest>,
